...
export default function Page() {
  ...
  <div className="bg-indigo-100 p-4 rounded-lg">
    ...
    <div className="mt-4 flex justify-between">
      <Link className=' text-indigo-400 hover:cursor-pointer hover:text-indigo-600 hover:bg-indigo-300 hover:rounded-md p-2 hover:bg-opacity-50' href='/calciumFact'>READ ARTICLE</Link>
    </div>
  </div>
</div>
