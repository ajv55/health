  ...
  return (
    <div className={`${style.background} w-full relative`}>
        <div className='w-full  flex justify-center items-center p-3 lg:p-4'>
            <p className='lg:mt-28 lg:w-[85%] mt-32 lg:text-4xl text-2xl lg:text-center text-left font-medium tracking-wide'>At <span className=' bg-gradient-to-bl from-indigo-900 via-indigo-500 to-indigo-400 bg-clip-text text-transparent'>FitGenius</span>, we understand that the journey to a <span className='font-bold text-gray-500'>healthier lifestyle </span> can be challenging, which is why we&#39;ve designed a <span className='font-bold text-gray-500'>comprehensive platform</span> to support you every step of the way. Whether your aim is to shed a <span className='font-bold text-gray-500'>few pounds</span>, <span className='font-bold text-gray-500'>build muscle</span>, or simply adopt <span className='font-bold text-gray-500'>healthier habits</span>, we&#39;re here to empower you with the tools and knowledge you need to succeed.</p>
        </div>
