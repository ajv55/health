  ...
  return (
    <div className='w-full relative'>
        ...
        <div className='w-full mt-20   flex flex-col gap-9 justify-center items-center'>
            ...
            <div className="w-[65%]  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            {/* <!-- Calorie Tracking --> */}
