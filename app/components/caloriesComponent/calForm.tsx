...
export default function CalForm({CancelBtnOnClick, selectVegetable, vegetablesData, vegetableOnChange, selectMeat, selectValue, meatsData , selectOnChange, meatOnChange, foodValue, foodOnChange, caloriesValue, caloriesOnChange, onSubmit, initialDate, onDateChange, selectfruit, fruitsData, fruitOnChange}: CalFormProps) {
  ...
  return (
    <div className='w-full absolute bg-transparent z-30 top-0 left-0 backdrop-blur-sm h-screen flex  justify-center items-center'>
        ...
        <form onSubmit={onSubmit} className='w-[67%] h-content bg-slate-100 drop-shadow-2xl rounded-2xl flex flex-col justify-start p-3 gap-4 items-center'>
        ...
        <label htmlFor="small" className="block mb-1 w-[65%] text-xl font-bold  dark:text-white">Meal Type</label>
        <select defaultValue={selectValue} onChange={selectOnChange}  id="small"  className="block w-[65%] px-3 py-2 drop-shadow-md border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
        ...
        <div className=" w-full flex justify-evenly items">
        ...
        <label htmlFor="small" className="block mb-1 w-full text-xl font-bold  dark:text-white">Vegetables</label>
