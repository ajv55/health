  ...
  return (
    <div className='relative flex flex-wrap mt-20 justify-center items-center  bg-gradient-to-bl from-emerald-800 via-emerald-600 to-emerald-300 w-full h-screen'>
        ...
        <div className=' relative  mt-48 flex w-[52%] h-[19rem]'>
            ...
            <nav className=' w-[33%]   text-white text-3xl font-light  tracking-wider flex flex-col justify-evenly items-start'>
               <Link className='hover:text-red-300 hover:text-3xl hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-0.5 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-white before:absolute before:left-0 before:bottom-0' href='#features'>FAQs</Link>
               <Link className='hover:text-blue-300 hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-0.5 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-white before:absolute before:left-0 before:bottom-0' href='/About'>Support</Link>
               <Link className='hover:text-orange-300 hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-0.5 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-white before:absolute before:left-0 before:bottom-0' href='/Contact'>Sign Up / Register</Link>
               <Link className='hover:text-teal-300 hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-0.5 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-white before:absolute before:left-0 before:bottom-0' href='/Pricing'>Login / Account</Link>
            </nav>
