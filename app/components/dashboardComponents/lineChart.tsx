...
export default function LineChart() {
  ...
  return (
    <div className='w-[47%] mt-28 h-content flex flex-col justify-center items-center gap-4 bg-slate-600 rounded-xl p-3'>
