...
const CarbInfo = () => {
  ...
  return (
    <div className="max-w-5xl mb-20 mx-auto p-6 bg-gray-100 rounded-lg shadow-md space-y-6">
      ...
      <div className='flex flex-col gap-4 justify-start items-start'>
        ...
        <Link className=' text-indigo-400 hover:cursor-pointer hover:text-indigo-600 hover:bg-indigo-300 hover:rounded-md p-2 hover:bg-opacity-50' href='/mainCarbs'>READ ARTICLE</Link>
      </div>
    </div>
  );
};
