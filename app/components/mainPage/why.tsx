...
export default function Why() {
  return (
    <div className='w-full h-[content] flex justify-start border-2 relative border-green-400 bg-gradient-to-tl from-emerald-900 via-emerald-700 to-emerald-300 mt-12 items-start flex-col gap-10'>
      <Tilt />
      <BottomTilt />
        ...
        <div className='border-2 w-full h-content flex flex-col justify-center'>
          <div className=' drop-shadow-xl  w-full h-[23rem] flex justify-evenly items-center gap-4 relative'>
            <div className=' relative'>
              ...
              <p className='text-3xl text-center text-white tracking-wide font-light w-[65%]'>At WeightTrack, <span className='font-bold text-4xl  bg-gradient-to-tl from-rose-700 via-orange-200 to-rose-600 bg-clip-text text-transparent'>we prioritize science and evidence-based methods</span> to help you achieve your weight loss goals. Our approach is <span className='font-bold text-3xl bg-gradient-to-br from-orange-200 via-red-300 to-red-700 bg-clip-text text-transparent'>rooted in research</span>, ensuring that every feature and recommendation is backed by scientific principles. Trust us to provide you with reliable information and <span className='font-bold text-3xl bg-gradient-to-br from-red-300 via-red-400 to-blue-900 bg-clip-text text-transparent'>effective strategies for sustainable weight loss</span>.</p>
          </div>
          ...
          */}
          ...
          <div className=' drop-shadow-xl  w-full h-[23rem] flex justify-evenly items-center relative'>
            <div className='relative'>
              ...
              <h1 className='text-5xl text-center bg-gradient-to-br  from-teal-800 via-red-500 to-yellow-300 bg-clip-text text-transparent  font-bold tracking-wide'>Comprehensive Support</h1>
            </div>
              <p className='text-3xl text-left text-white tracking-wide font-light w-[65%]'>Weight loss can be challenging, <span className='font-extrabold text-4xl bg-gradient-to-br from-amber-800 via-amber-500 to-amber-300 bg-clip-text text-transparent'>but you don&#39;t have to go it alone</span>. With WeightTrack, <span className='font-extrabold text-4xl bg-gradient-to-tr from-indigo-900 via-indigo-300 to-indigo-200 bg-clip-text text-transparent'>you&#39;ll have access to comprehensive support</span> every step of the way. Whether you have questions about nutrition, need motivation to stick to your workout routine, or simply want to connect with like-minded individuals, our team and community are here to support you. <span className='font-extrabold text-4xl bg-gradient-to-tr from-amber-800 via-amber-500 to-amber-200 bg-clip-text text-transparent'>We&#39;re committed to your success</span> and will do whatever it takes to help you reach your goals.</p>
          </div>
            {/* fourth reason */}
          <div className=' drop-shadow-xl  w-full h-[23rem] flex justify-evenly items-center relative'>
          <h1 className='text-[19rem] text-white -z-10 opacity-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>4</h1>
              <h1 className='text-5xl text-center bg-gradient-to-br  from-teal-800 via-red-500 to-yellow-300 bg-clip-text text-transparent border font-bold tracking-wide'> User-Friendly Interface</h1>
              <p className='text-2xl text-left text-white tracking-wide font-light w-[65%]'>At WeightTrack, <span className='font-bold  bg-gradient-to-tr from-rose-300 via-pink-500 to-blue-900 bg-clip-text text-transparent'>we prioritize science and evidence-based methods</span> to help you achieve your weight loss goals. Our approach is rooted in research, ensuring that every feature and recommendation is backed by scientific principles. Trust us to provide you with reliable information and effective strategies for sustainable weight loss.</p>
          </div>

            {/* fifht reason */}
            <div className=' drop-shadow-xl  w-full h-[23rem] mb-64 flex justify-evenly items-center relative'>
            <h1 className='text-[19rem] text-white -z-10 opacity-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>5</h1>
                <h1 className='text-5xl text-center bg-gradient-to-br  from-teal-800 via-red-500 to-yellow-300 bg-clip-text text-transparent border font-bold tracking-wide'> Positive Results</h1>
                <p className='text-2xl text-left text-white tracking-wide font-light w-[65%]'>At WeightTrack, <span className='font-bold  bg-gradient-to-tr from-rose-300 via-pink-500 to-blue-900 bg-clip-text text-transparent'>we prioritize science and evidence-based methods</span> to help you achieve your weight loss goals. Our approach is rooted in research, ensuring that every feature and recommendation is backed by scientific principles. Trust us to provide you with reliable information and effective strategies for sustainable weight loss.</p>
            </div>
