    ...
    <div  className={`${style.background} bg-gray-100 py-12`}>
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-4xl leading-8 font-extrabold tracking-tight text-gray-500 sm:text-4xl">
        ...
        >
          {/* Card 1 */}
          <motion.div ref={ref} transition={{duration: 0.5, stiffness: 120, type: 'spring'}} whileHover={{scale: 1.1, rotate: 5}}  className="bg-white group hover:bg-gradient-to-br hover:from-indigo-950 hover:via-indigo-700  hover:to-indigo-950 rounded-lg shadow-md hover:shadow-indigo-600 p-6" variants={cardVariants}>
          ...
          {/* Card 2 */}
          <motion.div transition={{duration: 0.5, stiffness: 120, type: 'spring'}} whileHover={{scale: 1.1, rotate: -5}}  className="bg-white group   hover:bg-gradient-to-br hover:from-indigo-950 hover:via-indigo-700  hover:to-indigo-950 hover:shadow-indigo-600 rounded-lg shadow-md p-6" variants={cardVariants}>
          ...
          {/* Card 3 */}
          <motion.div transition={{duration: 0.5, stiffness: 120, type: 'spring'}} whileHover={{scale: 1.1, rotate: 5}}  className="bg-white hover:bg-gradient-to-br hover:from-indigo-950 hover:via-indigo-700 hover:shadow-indigo-600  hover:to-indigo-950 group rounded-lg shadow-md p-6" variants={cardVariants}>
          ...
          {/* Card 4 */}
          <motion.div transition={{duration: 0.5, stiffness: 120, type: 'spring'}} whileHover={{scale: 1.1, rotate: -5}}  className="bg-white group hover:bg-gradient-to-br hover:from-indigo-950 hover:via-indigo-700 hover:shadow-indigo-600  hover:to-indigo-950 rounded-lg shadow-md p-6" variants={cardVariants}>
