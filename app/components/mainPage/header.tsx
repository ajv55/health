...
export default function Header() {
  return (
    <div style={{
        ...
        <h1 className='lg:text-7xl text-center text-white font-bold tracking-wide'>Lose Weight The <span className=' bg-gradient-to-br text-8xl from-orange-900 via-orange-600 to-orange-300 bg-clip-text text-transparent '><Typewriter words={['Scientific', 'Accurate', 'Deductive', 'Methodical ', 'Mathematical', 'Experimental']} loop={0} typeSpeed={100} deleteSpeed={80} delaySpeed={2000}  cursorStyle={'!'} /></span> Way</h1>
