...
export default function Header() {
  return (
    <div  className=' bg-slate-100 lg:w-full h-[37rem] flex flex-col lg:gap-16  bg-cover bg-center justify-center items-center gap-12 lg:justify-center lg:items-center '>
        ...
        <p className='lg:text-3xl  text-xl text-center lg:text-left font-light tracking-wide w-full lg:p-0 p-1 lg:w-[80%]'>Personalized <span className='font-bold bg-gradient-to-bl from-teal-800 via-teal-500 to-teal-200 bg-clip-text text-transparent'>meal plans</span>, workout <span className='font-bold bg-gradient-to-br from-indigo-800 via-indigo-500 to-indigo-300 bg-clip-text text-transparent'>routines</span>, and progress <span className='font-bold bg-gradient-to-bl from-cyan-800 via-cyan-500 to-cyan-200 bg-clip-text text-transparent'>tracking</span> to help you achieve your weight loss goals.</p>
