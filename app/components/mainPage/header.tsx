...
export default function Header() {
  return (
    <div style={{
        ...
        <Link href='/login' className='focus:outline-none text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 lg:mb-32 font-medium rounded-lg lg:text-4xl text-sm px-5 py-2.5 me-2 mb-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-900'>Get Started!</Link>
    </div>
  )
}
