...
export default function How() {
  ...
  return (
    <section className='w-full h-content bg-gradient-to-br from-emerald-900 via-emerald-700 to-emerald-200 relative flex flex-col justify-start gap-12 items-center'>
        ...
        <h1 className='text-7xl text-center text-white mt-44 tracking-wide font-bold'>How It Works: <br /> <br /> <motion.span  variants={{visible: { x: 0, opacity: 1 }}} initial={{ x: '-100vw', opacity: 0 }} animate={mainControls} transition={{duration: 0.35, type: 'spring', delay: 0.25}} className='font-extrabold text-8xl bg-gradient-to-br from-blue-200 via-amber-600 to-cyan-300 bg-clip-text text-transparent'>Your Roadmap to Success</motion.span></h1>
