...
export default function ThirdReason() {
  ...
  return (
    <motion.div ref={ref} variants={{visible: {scale: 1, opacity: 1, x: 0}}} initial={{scale: 0, opacity: 0, x: 100}} animate={mainControls} transition={{duration: 0.55, type: 'spring', delay: 0.25}} className=' drop-shadow-xl  w-full h-[23rem] flex justify-evenly items-center relative'>
