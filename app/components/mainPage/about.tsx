...
export default function About() {
  return (
    <div className='w-full h-content flex flex-col gap-9 justify-start items-start '>
        ...
        <motion.div initial={{scale: 0, opacity: 0, x: -100}} whileInView={{scale: 1, opacity: 1, x: 0}} transition={{duration: 0.45, type: 'spring', delay: 0.25}}  className='mt-24  w-full flex justify-evenly items-center h-[40rem]'>
