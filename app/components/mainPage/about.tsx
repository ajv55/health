  ...
  return (
    <div className='w-full h-content flex flex-col gap-9 justify-start items-start '>
        ...
        <motion.div initial={{scale: 0, opacity: 0, x: -100}} whileInView={{scale: 1, opacity: 1, x: 0}} transition={{duration: 0.45, type: 'spring', delay: 0.25}}  className='mt-24  w-full flex flex-col lg:flex-row justify-evenly items-center h-content lg:h-[40rem]'>
            <div className='bg-cover rounded-3xl   bg-center relative w-[95%] h-[27rem]  lg:w-[43rem] lg:h-[33rem]' style={{backgroundImage: 'linear-gradient(to right,rgba(0,0,0,0), rgba(0,0,0,0)), url("/empower.png")'}}>
                <div className='bg-amber-800 rounded-3xl drop-shadow-2xl w-full lg:h-[33rem] h-[27rem] absolute top-3 left-3 -z-10'></div>
            </div>

            <div className=' lg:w-[45%] w-full h-[100%] lg:mt-0 mt-10 flex lg:gap-0 gap-6 justify-evenly items-center  flex-col'>
                <h1 className='font-bold tracking-wide bg-gradient-to-tr from-amber-700 via-amber-500 to-yellow-300 bg-clip-text text-transparent lg:text-6xl text-5xl text-center'>Empowerment</h1>
        ...
        <motion.div initial={{scale: 0, opacity: 0, x: -100}} whileInView={{scale: 1, opacity: 1, x: 0}} transition={{duration: 0.45, type: 'spring', delay: 0.25}} className='mt-5  w-full flex flex-col lg:flex-row-reverse justify-evenly items-center lg:h-[40rem]'>
            <div className='bg-cover rounded-3xl   bg-center relative w-[95%] h-[27rem]  lg:w-[43rem] lg:h-[33rem]' style={{backgroundImage: 'linear-gradient(to right,rgba(0,0,0,0), rgba(0,0,0,0)), url("/Inclusive.jpg")'}}>
                <div className='bg-stone-600 rounded-3xl drop-shadow-2xl w-full lg:h-[33rem] h-[27rem]  absolute top-3 right-3 -z-10'></div>
            </div>

            <div className=' lg:w-[45%] w-full  h-[100%] lg:mt-0 mt-10 flex lg:gap-0 gap-6 justify-evenly items-center  flex-col'>
                <h1 className='font-bold tracking-wide bg-gradient-to-tr from-stone-700 via-stone-500 to-zinc-300 bg-clip-text text-transparent lg:text-6xl text-5xl text-center'>Inclusivity</h1>
        ...
        <motion.div initial={{scale: 0, opacity: 0, x: -100}} whileInView={{scale: 1, opacity: 1, x: 0}} transition={{duration: 0.45, type: 'spring', delay: 0.25}} className='mt-5  w-full flex-col lg:flex-row  justify-evenly items-center lg:h-[40rem]'>
            ...
            <div className=' lg:w-[45%] w-full  h-[100%] lg:mt-0 mt-10 lg:gap-0 gap-6  flex justify-evenly items-center  flex-col'>
                <h1 className='font-bold tracking-wide bg-gradient-to-tr from-teal-800 via-sky-500 to-purple-300 bg-clip-text text-transparent lg:text-6xl text-5xl text-center'>Science-Based Approach</h1>
        ...
        <motion.div initial={{scale: 0, opacity: 0, x: -100}} whileInView={{scale: 1, opacity: 1, x: 0}} transition={{duration: 0.45, type: 'spring', delay: 0.25}} className='mt-5  w-full flex flex-col lg:flex-row-reverse justify-evenly items-center lg:h-[40rem]'>
            <div className='bg-cover rounded-3xl   bg-center relative  w-[95%] h-[27rem]  lg:w-[43rem] lg:h-[33rem]' style={{backgroundImage: 'linear-gradient(to right,rgba(0,0,0,0), rgba(0,0,0,0)), url("/personal2.jpg")'}}>
