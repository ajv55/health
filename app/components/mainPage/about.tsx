...
export default function About() {
  return (
    <div className='w-full h-content flex flex-col gap-9 justify-start items-start '>
        ...
        <div className='mt-5  w-full flex flex-row-reverse justify-evenly items-center h-[40rem]'>
        ...
        <div className='mt-5  w-full flex  justify-evenly items-center h-[40rem]'>
