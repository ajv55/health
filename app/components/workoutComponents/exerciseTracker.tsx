    ...
    <div className="w-[89%]  relative mx-auto bg-white rounded-lg shadow-md mt-9 p-6">
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center space-x-2">
          <Link href='/dashboard/workout/search' onMouseOver={() => setIsOver(true)} onMouseLeave={() => setIsOver(false)} className="bg-indigo-500 absolute flex justify-center items-center -top-6 -left-7 drop-shadow-xl text-white h-14 w-14 p-2 rounded-full hover:bg-indigo-600 transition duration-300">
            <FaPlus size={24} color='white' />
          </Link>
          <Link href='/dashboard/workout/search'><IoSearchOutline  size={26} color="black" /></Link>
        </div>
