...
export default function SupportMoreInfo() {
  return (
    <div className="w-[75%] p-6 bg-white shadow-md shadow-indigo-400 rounded-lg">
        <h1 className="text-5xl font-bold text-indigo-600 mb-6">Nutritional Guide</h1>

        <section className="mb-8">
        <h2 className="text-4xl text-gray-500 font-semibold mb-4">Basics of Nutrition</h2>
        <p className="mb-4 text-xl">Understanding nutrition is key to achieving your weight loss goals. Here&#39;s a quick guide:</p>
        
        <div className="mb-4">
            <h3 className="text-2xl text-indigo-600 font-semibold">Macronutrients:</h3>
        ...
        <h2 className="text-2xl text-indigo-600 font-semibold mb-4">Balanced Diet Tips</h2>
        ...
        <section className="mb-8">
        <h2 className="text-2xl text-indigo-600 font-semibold mb-4">Sample Meal Plan</h2>
        <p className="mb-4 text-xl">Here&#39;s a sample daily meal plan to get you started:</p>
        
        <div className="mb-4">
            <h3 className="text-2xl text-indigo-600 font-semibold">Breakfast:</h3>
            <ul className="list-disc text-xl list-inside ml-4">
        ...
        <div className="mb-4">
            <h3 className="text-2xl text-indigo-600 font-semibold">Lunch:</h3>
            <ul className="list-disc text-xl list-inside ml-4">
        ...
        <div className="mb-4">
            <h3 className="text-2xl text-indigo-600 font-semibold">Dinner:</h3>
            <ul className="list-disc text-xl list-inside ml-4">
        ...
        <div className="mb-4">
            <h3 className="text-2xl text-indigo-600 font-semibold">Snacks:</h3>
            <ul className="list-disc text-xl list-inside ml-4">
        ...
        <section className="mb-8">
        <h2 className="text-2xl text-indigo-600 font-semibold mb-4">Science-Based Techniques</h2>
        ...
        <section className="mb-8">
        <h2 className="text-2xl text-indigo-600 font-semibold mb-4">Frequently Asked Questions (FAQ)</h2>
