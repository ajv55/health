...
export default function Nav() {
  return (
    <div className='lg:w-full bg-transparent w-full   z-10 absolute top-0 lg:h-content py-3 flex justify-between items-center p-3'>
        ...
        <RiMenu3Line className='lg:hidden' size={30} color='white' />
        <Signing />
    </div>
  )
}
