    ...
    <div className='w-full flex flex-col justify-center items-center  relative'>
        ...
        <div className='w-full flex flex-col  justify-center items-center'>
         ...
         {/* Understanding Macronutrients */}
            ...
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl text-white lg:text-black font-semibold mb-4">Creating Balanced Meals</h2>
                <p className="lg:text-gray-700 text-white lg:text-2xl text-xl">Discover how to create balanced meals that provide a mix of macronutrients, vitamins, and minerals essential for optimal health. We&#39;ll provide simple meal planning tips and sample meal ideas to get you started.</p>
            </div>

            {/* <!-- Smart Food Choices --> */}
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl font-semibold mb-4">Smart Food Choices</h2>
            ...
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl  lg:text-white font-semibold mb-4">Pre- and Post-Workout Nutrition</h2>
                <p className="lg:text-white lg:text-2xl text-xl">Fueling your body properly before and after exercise is crucial for performance and recovery. Discover the best foods to eat before and after your workouts to maximize energy levels, enhance muscle growth, and support recovery.</p>
            </div>
            ...
            {/* <!-- Supplements --> */}
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl font-semibold mb-4">Supplements</h2>
            ...
            {/* <!-- Hydration --> */}
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl font-semibold mb-4">Hydration</h2>
            ...
            <div className="mb-8">
                <h2 className="lg:text-5xl text-4xl font-semibold mb-4">Nutrition for Specific Goals</h2>
        ...
        <p className='mt-24 lg:text-4xl text-2xl tracking-wider text-center lg:w-[85%] w-full lg:p-0 p-2'>Thank you for visiting <span className='font-bold'>Fitness Finesse</span>. We hope this <span className='font-bold'>ultimate nutrition guide</span> has provided you with valuable insights and <span className='font-bold'>practical tips</span> to optimize your diet and <span className='font-bold'>enhance your overall health</span> and fitness journey. Be sure to check back regularly for more informative articles and resources to support your wellness goals.</p>
        <Footer />
    </div>
  )
}
