...
export default function ExtraInfo() {
  return (
        ...
        <div className="lg:max-w-6xl w-[95%] mx-auto p-6 bg-slate-100 rounded-lg shadow-md shadow-indigo-400 mt-10">
            <h1 className="lg:text-6xl text-indigo-600 text-4xl font-semibold mb-4">Privacy Policy</h1>
            
            <div className="mt-6">
                <h2 className="text-2xl font-semibold  text-indigo-600 mb-2">Data Security</h2>
            ...
            <div className="mt-6">
                <h2 className="text-2xl font-semibold  text-indigo-600 mb-2">Cookies and Tracking Technologies</h2>
