...
export default function Share() {
  return (
    <div className=" lg:max-w-6xl w-[95%] mx-auto mt-10 p-6 bg-slate-100 rounded-lg shadow-md shadow-indigo-400">
        <h2 className="lg:text-6xl text-4xl font-bold text-indigo-600 mb-4">Sharing Your Information</h2>
        ...
        <div className="bg-gray-100 p-4 rounded-lg shadow-inner mb-4">
            <h3 className="text-2xl font-semibold text-indigo-600 mb-2">Service Providers</h3>
        ...
        <div className="bg-gray-100 p-4 rounded-lg shadow-inner">
            <h3 className="text-2xl font-semibold text-indigo-600 mb-2">Legal Requirements</h3>
