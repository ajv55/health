...
export default function Share() {
  return (
    <div className=" max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md shadow-zinc-900">
        <h2 className="text-6xl font-bold text-gray-800 mb-4">Sharing Your Information</h2>
