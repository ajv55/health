  ...
  return (
    <div className='bg-slate-900 mt-14 overflow-scroll flex flex-col lg:flex-wrap lg:flex-row justify-between items-center  w-full h-content'>
      <div className="flex gap-5 lg:w-[45%] w-full flex-col justify-center items-center">
        <h1 className="lg:text-7xl text-4xl text-white font-bold tracking-wide">Lunch</h1>
        <div style={{backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.4)), url(${list[0]?.[1]?.lunch?.img})`}} className="lg:w-[65%] w-[85%] h-[23rem] flex rounded-xl justify-center items-center bg-center bg-cover">
