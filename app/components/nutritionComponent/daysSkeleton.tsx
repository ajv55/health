...
export default function DaysSkeleton() {
  return (
    
        <div role="status" className="space-y-8 w-full h-[32rem] p-7 bg-slate-900 absolute animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse flex justify-center items-center">
            <div className="flex items-center justify-center w-[50%] h-52 bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
